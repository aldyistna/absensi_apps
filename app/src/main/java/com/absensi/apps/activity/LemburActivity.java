...
public class LemburActivity extends AppCompatActivity {
    private static final String TAG = LemburActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressButton = new ProgressButton(LemburActivity.this, btnSave);
        backButton = new ProgressButton(LemburActivity.this, btnBack);
    ...
    private void saveLembur(String ket) {
        AsyncHttpClient client = new AsyncHttpClient();
        String urlPath = "api/lembur";
        ...
        client.post(API_URL + urlPath, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                makeToast("Berhasil save lembur");
                Handler handler = new Handler();
                handler.postDelayed(() -> {
                    startActivity(new Intent(LemburActivity.this, MainActivity.class)
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ...
                makeToast("Terjadi kesalahan, silahkan input lembur ulang");
